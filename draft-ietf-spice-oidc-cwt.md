...
The claim names and descriptions are substantially the same as those in {{OpenID.Core}}.
...
The following CDDL Schema {{RFC8610}} includes example values for each item.
